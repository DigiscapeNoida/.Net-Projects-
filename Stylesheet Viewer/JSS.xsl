        ...
        <html>
            ...
            <body onkeyup="keyDown=0" onkeydown="keyDown=1">
                ...
                <table width="1000" border="1" style="margin-top:20pt;">
                    <tr>
                        <td colspan="2" align="center" style="font-weight:bold;">Version 2019.3 | ©
                            2018 Elsevier | Contact: Rob van Fucht <span
                                style="font-size:14; font-weight:normal"
                                >(R.Fucht@elsevier.com)</span>, Vanaja Sriram <span
                                style="font-size:14; font-weight:normal"
                                >(v.sriram@elsevier.com)</span>, <br/>Senthil Ammaiyan Subbaiah
                                <span style="font-size:14; font-weight:normal"
                                >(S.Ammaiyalsubbaiah@elsevier.com)</span></td>
                    </tr>
                </table>
