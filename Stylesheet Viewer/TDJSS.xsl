...
<!--    
    ...
    Copyright (c) 2009-2015 Elsevier Ltd    
-->
<!--
...
<!--                <script src="activatables.js" type="text/javascript"/>
                ...
                <table width="1000" border="1" style="margin-top:20pt;"><tr><td colspan="2" align="center" style="font-weight:bold;">Version 2015.4 | © 2015 Elsevier | Contact: Rob van Fucht <span style="font-size:14; font-weight:normal">(R.Fucht@elsevier.com)</span>, Gopinath Rajasekaran <span style="font-size:14; font-weight:normal">(g.rajasekaran@elsevier.com)</span>, <br/>Vanaja Sriram <span style="font-size:14; font-weight:normal">(v.sriram@elsevier.com)</span></td></tr></table>
    ...
    <xsl:template match="jss:journalStylesheet/jss:baseData" name="main">
        ...
        <table border="4" width="1000pt">
            ...
            <tr>
                ...
                <td>
                    <font class="rhs">
                        <xsl:value-of select="//jss:ptsData/jss:journalTitle" disable-output-escaping="yes"/>
                    </font>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <xsl:choose>
                        <xsl:when test="//jss:ptsData/jss:epGroup!=''">
                            <font class="rhs">
                                <xsl:value-of select="//jss:ptsData/jss:epGroup" disable-output-escaping="yes"/>
                            </font>
                        </xsl:when>
                        <xsl:when test="//jss:ptsData/jss:epGroup=''">
                            <font class="rhs_nodata">
...
<xsl:text>&#160;&#160;&#160;&#160;</xsl:text>
                    ...
                    <xsl:choose>
                        <xsl:when test="//jss:ptsData/jss:journalManager/@emailId!=''">
                            <font class="rhs">
                                <xsl:value-of select="//jss:ptsData/jss:journalManager/@emailId"/><br/>
                            </font>
                        </xsl:when>
                        <xsl:when test="//jss:ptsData/jss:journalManager/@emailId=''">
                            <font class="rhs_nodata">
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:JM-EditData/jss:referenceStyleComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
        ...
        <!--<tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:JM-EditData/jss:approvedNonStandardComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:JM-EditData/jss:specialIssuesComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        <xsl:when test="//jss:JM-EditData/jss:SI_footnote = 0">
                            <font class="rhs">
                                <xsl:text>No</xsl:text>
                            </font>
                        </xsl:when>
                        <xsl:when test="//jss:JM-EditData/jss:SI_footnote = 1">
                            <font class="rhs">
                                <xsl:text>Yes</xsl:text>
                            </font>
                        </xsl:when>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        <xsl:when test="//jss:JM-EditData/jss:SI_footnoteComment/jss:p">
                            <xsl:for-each select="//jss:JM-EditData/jss:SI_footnoteComment/jss:p">
                                <font class="rhs">
                                    <xsl:value-of select="." disable-output-escaping="yes"/>
                                    <br/>
                                </font>
                        ...
                        <xsl:when test="//jss:JM-EditData/jss:SI_footnoteComment=''">
                            <font class="rhs_nodata">
                                <xsl:text>Contains no data</xsl:text>
                            </font>
                        </xsl:when>
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:JM-EditData/jss:SI_footnoteComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:JM-EditData/jss:docheadComments" disable-output-escaping="yes"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of disable-output-escaping="yes" select="//jss:JM-EditData/jss:sectionComments"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:pilot/jss:pilotSpecificComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of disable-output-escaping="yes" select="//jss:otherInstructions"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:itemreceipt/jss:scanS0Comment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:itemreceipt/jss:extLoginComment" disable-output-escaping="yes"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:itemreceipt/jss:quickBookComment" disable-output-escaping="yes"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of disable-output-escaping="yes" select="//jss:itemreceipt/jss:otherReceipt"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:additionalLoginInstructions" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:docHeads/jss:docheadComments" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:sectionHeads/jss:sectionComments" disable-output-escaping="yes"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
    ...
    <xsl:template match="jss:journalStylesheet/jss:cu" name="cu">
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:history/jss:journalSpecificHistoryComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
       ...
       <!--<tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:history/jss:historyItemGroupComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:history/jss:onlinePubDateComment" disable-output-escaping="yes"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
            ...
            <tr>
                ...
                <td colspan="3">
                    <xsl:choose>
                        <xsl:when test="//jss:history/jss:editorName = 0">
                            <font class="rhs">
                                <xsl:text>No</xsl:text>
                            </font>
                        </xsl:when>
                        <xsl:when test="//jss:history/jss:editorName = 1">
                            <font class="rhs">
                                <xsl:text>Yes</xsl:text>
                            </font>
                        </xsl:when>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        <xsl:when test="//jss:history/jss:editorNameComment/jss:p">
                            <xsl:for-each select="//jss:history/jss:editorNameComment/jss:p">
                                <font class="rhs">
                                    <xsl:value-of select="." disable-output-escaping="yes"/>
                                    <br/>
                                </font>
                        ...
                        <xsl:when test="//jss:history/jss:editorNameComment=''">
                            <font class="rhs_nodata">
                                <xsl:text>Contains no data</xsl:text>
                            </font>
                        </xsl:when>
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:history/jss:editorNameComment" disable-output-escaping="yes"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:abstract/jss:abstractComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:graphicalAbstract/jss:journalSpecificGraphicalAbstractComment" disable-output-escaping="yes"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:graphicalAbstract/jss:journalSpecificGATOCComment" disable-output-escaping="yes"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:graphicalAbstract/jss:journalSpecificGATitlePageComment" disable-output-escaping="yes"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:highlights/jss:journalSpecificHighlightsComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
                ...
                <td>
                    <xsl:choose>
                        <xsl:when test="//jss:classificationSectionHeading/jss:CSHeading">
                            <font class="tbl1"><xsl:for-each select="//jss:classificationSectionHeading/jss:CSHeading">
                                <xsl:apply-templates/><xsl:if test="position()!=last()"><xsl:text>; </xsl:text></xsl:if>
                            </xsl:for-each></font>
                        </xsl:when>
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:classification/jss:classificationComment" disable-output-escaping="yes"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
            ...
            <tr>
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:colour/jss:firstPageFOCComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:colour/jss:colourComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:correspondence/jss:correspondenceAuthorComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:offprints/jss:freeIssuesComment" disable-output-escaping="yes"
                                />
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                ...
                <td colspan="3">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:offprints/jss:freeIssuesSIComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:heading/jss:NSComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:roles/jss:mottoComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:roles/jss:caseReportComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:roles/jss:noteinProofComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:roles/jss:materialsMethodsComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:roles/jss:resultsComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:roles/jss:introSecComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:roles/jss:backgroundComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:roles/jss:conclusionComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:roles/jss:discussionComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:intro/jss:introductionComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:CoI/jss:CoIComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:bioInfo/jss:ADComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:floatLabel/jss:NSFloatLabel" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of 
                                    select="//jss:artwork/jss:journalSpecificArtworkComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:latexInfo/jss:latexComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
                ...
                <td>
                    <xsl:choose>
                        <xsl:when test="//jss:additionalS100/jss:additionalS100Comment/jss:p">
                            <xsl:for-each select="//jss:additionalS100/jss:additionalS100Comment/jss:p">
                                <font class="rhs">
                                    <xsl:value-of select="." disable-output-escaping="yes"/>
                                    <br/>
                                </font>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:additionalS100/jss:additionalS100Comment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:mc/jss:mastercopyingComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:additionalS200" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:additionalP100" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:journalSpecificCoverComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:specialIssueCoverComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:runOnItemsComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:journalSpecificIndexComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:stylePrintedIssue/jss:additionalPrint" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of disable-output-escaping="yes" select="//jss:style-e-issue/jss:additionalE"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:proofing/jss:proofingGeneric/jss:journalSpecificProofingComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:proofing/jss:proofingGeneric/jss:changesPDFProofTextComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
...
<!--                            <xsl:otherwise>
                ...
                <tr>
                    ...
                    <td>
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <font class="rhs">
                                    <xsl:value-of select="jss:proofingComment" disable-output-escaping="yes"/>
                                </font>
                            </xsl:otherwise>
                        </xsl:choose>
                    </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:multipleVersionComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:tipOnsComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:tipInsComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:coverPerIssueComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:coverStockComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:advanceApprovalComment" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:additionalPrinter" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <font class="rhs">
                                <xsl:value-of select="//jss:otherJournalSpecificDespatch" disable-output-escaping="yes"/>
                            </font>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
    ...
    <xsl:template match="jss:journalStylesheet/jss:standardText" name="stdtxt">
       ...
       <br/>
        <h3 align="left" class="head3">Texts for journals with copyright Elsevier GmbH</h3>
        <xsl:for-each select="//jss:elsevierGmbHCopyright">
           <xsl:if test="./jss:sectiontitle">
               <xsl:text>&#8195;</xsl:text>
               <font class="head4">
                   <xsl:value-of select="./jss:sectiontitle"/>
        ...
        <br/>
        <h3 align="left" class="head3">Illustration services</h3>
        <xsl:text>&#8195;</xsl:text>
        <xsl:if test="//jss:illustrationServices/jss:sectiontitle">
            <font class="head4">
                <xsl:value-of select="//jss:illustrationServices/jss:sectiontitle"/>
                <xsl:text>: </xsl:text>
            </font>
        </xsl:if>
        <xsl:for-each select="//jss:illustrationServices/jss:p">
            <xsl:value-of select="." disable-output-escaping="yes"/>
            <br/>
            <br/>
        </xsl:for-each>
