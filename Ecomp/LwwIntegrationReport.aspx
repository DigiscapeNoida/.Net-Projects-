<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LwwIntegrationReport.aspx.cs" Inherits="_Default" %>
...
<asp:GridView ID="gridviewDetails" runat="server" AutoGenerateColumns="false" 
    ...
    <Columns>
        ...
        <asp:BoundField ItemStyle-Width="150px" DataField="TaskName" HeaderText="TaskName" />
        <asp:BoundField ItemStyle-Width="150px" DataField="DownloadedOn" HeaderText="DownloadDate" />
        <asp:BoundField ItemStyle-Width="150px" DataField="IntegratedOn" HeaderText="IntegrateDate" />
