...
public partial class CreateEcomp : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        //CheckExtendedIsbn("9788131262931");
        txtContactEmail.Text = "abilaasha.sampath@thomsondigital.com";
        //txtRecipientEmail.Text = "abilaasha.sampath@thomsondigital.com";
    ...
    protected void btnsubmitClick(Object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                sw.WriteLine("Cover-Path=\\" + ecopmFolder + "\\" + minisbn + "_" + surName + "\\cover.pdf");
                ...
                mailClient.Send(mail); //Stopped by vivek as mail not required for MRW

                Response.Write("<script>alert('Ecomp has been genrated.')</script>");
                return;
            }
        }
        catch (Exception ex)
