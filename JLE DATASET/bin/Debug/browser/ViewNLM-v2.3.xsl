<?xml version="1.0"?>
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="http://dtd.nlm.nih.gov/xsl/util" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:m="http://www.w3.org/1998/Math/MathML" xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:td="http://me.com/namespaces/tdtd" xmlns:tp="http://me.com/namespaces/tptp" xmlns:ce="http://www.elsevier.com/xml/common/dtd" xmlns:sb="http://www.elsevier.com/xml/common/struct-bib/dtd" xmlns:t="myURI" xmlns:func="urn:schemas-microsoft-com:xslt">
<!--
		...
		<html xmlns:mml="http://www.w3.org/1998/Math/MathML">
			...
			<body bgcolor="#f8f8f8">
				<OBJECT ID="MathPlayer" CLASSID="clsid:32F66A20-7614-11D4-BD11-00104BD3F987">
					<span style="color:red">To properly view the mathematics on these pages, you must use Microsoft's Internet Explorer browser, version 6.0 and later, and have Design Science's MathPlayer software installed. To install MathPlayer, click on this <a href="http://www.dessci.com/getmp">link</a>.</span>
					<br/>
					<span style="color:red">You might also want to download some additional fonts for equations with the more exotic symbols. Click on this <a href="http://web.mit.edu/atticus/www/mathml/mit-mathml-fonts-1.0-fc1.msi">link</a>
					</span>.<br/>
					<br/>
				</OBJECT>
				<xsl:processing-instruction name="IMPORT">
				 NAMESPACE="mml" IMPLEMENTATION="#MathPlayer"
	...
	<xsl:template name="make-figs-and-tables">
		...
		<xsl:if test="floats-group//fig">
			...
			<table width="100%" class="bm">
				<xsl:call-template name="table-setup-l-wide"/>
				<!-- each figure is a row -->
				<xsl:apply-templates select="floats-group//fig | body//fig | back//fig" mode="put-at-end"/>
			</table>
		...
		<xsl:if test="floats-group//table-wrap | back//table-wrap">
			<hr class="section-rule"/>
			<xsl:call-template name="nl-1"/>
			...
			<xsl:apply-templates select="floats-group//table-wrap | back//table-wrap" mode="put-at-end"/>
			<xsl:call-template name="nl-1"/>
		</xsl:if>
...
NAMESPACE="mml" IMPLEMENTATION="#MathPlayer"
				...
				<title>WileyML XSLT Transformation</title>
