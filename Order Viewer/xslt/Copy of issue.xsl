	...
	<xsl:template match="issue-remarks">
		<table width="100%">
			<xsl:for-each select="issue-remark[remark-type!='ADV' or @type!='ADV']">
                ...
                <td width="40%">
                    <font color="red"><xsl:value-of select="diff/remark"/></font>
                </td>
		</xsl:when>
                <xsl:otherwise>
                <td width="40%">
