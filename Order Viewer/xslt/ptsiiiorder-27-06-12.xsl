...
<!-- $Id: ptsiiiorder.xsl,v 1.15 2012/03/15 12:38:17 grajasek Exp $ -->
<!--
     version 1.4  15 March 2012
     Copyright (c) 2011-2012 Elsevier B.V.
-->
<!--
...
<!--                    <td>
    ...
    <xsl:template match="issue-remarks">
        ...
        <xsl:if test="//buffer-status/@status='yes'">
            <p>
		<b>
		<span style="color:green">Buffer issue: do not despatch to the warehouse until instructed by the Production Site.</span>
		</b>
            </p>
        </xsl:if>
        <xsl:apply-templates select="issue-remark[remark-type!='Advert details' and remark-type!='ADV']"/>

<!-- Differencing for Issue Ramarks 23-03-2012   -->
...
<!--        <div id="" style="background-color:#D7FFCF; position: relative; left:0.3%; border-style:solid; border-width:1; padding:5">
            ...
            <br/>
            <span id="xmlcode" onclick="expColl(part0,expanded0,this)" style="color:red; font-weight:900; font-size:150%; font-family:courier"
