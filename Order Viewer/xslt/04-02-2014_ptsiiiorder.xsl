...
<!-- $Id: ptsiiiorder.xsl,v 1.11 2011/09/13 07:42:29 jmigchie Exp $ -->
<!--
     version 1.3r1  13 September 2011
     Copyright (c) 2011 Elsevier B.V.
-->
<!--
    v1.3r1  13 September 2011  [PTS release 2011.3]
    Changes with respect to v1.2:
    - Displaying new refers-to-documents subelements jid and aid
...
<!--				<tr>
	...
	<xsl:template match="item-info">
		<!-- Table with part of item information. Layout:
            ...
            copyright received date  refers-to-document
            embargo                  
            embargo-until-stage      e-submission-item-nr
            righthand start          eo-item-nr
            online publication date  editor
            online version           received date
            corrections              revised date
            offprint payment         accept date
        -->
		<p>
			<table width="100%">
				<tr>
	...
	<xsl:template match="issue-content" mode="ISSUE">
		<!-- table, 24 columns, content from issue-content/row -->
		<p>
			<table width="100%">
				<tr>
					<th>
