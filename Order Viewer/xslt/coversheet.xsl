...
<!--
    ...
    Copyright (c) 2003-2009 Elsevier B.V.
    $Id: coversheet.xsl,v 1.13 2009/05/26 11:16:32 jmigchie Exp $
-->
<!--
    v1.5  26 May 2009  [PTSIII release 2009.1]
    Changes with respect to v1.4
    * JMi: Displaying new elements nihms-id and pubmedcentral-id
    * JMi: Removed display of elements grant-numbers and principal-investigator
...
var expanded0 = {status:1};
            ...
            <body style="font-family:'Arial Unicode MS'"
                ...
                <xsl:for-each select="order">
                    ...
                    <table width="100%">
						...
						<!-- For ABP -->
                        <xsl:if test="item-info/assigned-to-issue">
                            <table>
                                <tr>
                                    <td>ABP INFORMATION</td>
                                    <td/>
                                </tr>
                                <tr>
                                    <td>Issue PII:</td>
                                    <td>
                                        <xsl:value-of select="item-info/assigned-to-issue/pii"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Effect cover date:</td>
                                    <td>
                                        <xsl:value-of
                                            select="item-info/assigned-to-issue/effect-cover-date"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Volume/Issue:</td>
                                    <td>
                                        <xsl:call-template name="insert-voliss-info">
                                            <xsl:with-param name="vol-from">
                                                <xsl:value-of
                                                  select="item-info/assigned-to-issue/vol-from"/>
                                            </xsl:with-param>
                                            <xsl:with-param name="vol-to">
                                                <xsl:value-of
                                                  select="item-info/assigned-to-issue/vol-to"/>
                                            </xsl:with-param>
                                            <xsl:with-param name="iss-from">
                                                <xsl:value-of
                                                  select="item-info/assigned-to-issue/iss-from"/>
                                            </xsl:with-param>
                                            <xsl:with-param name="iss-to">
                                                <xsl:value-of
                                                  select="item-info/assigned-to-issue/iss-to"/>
                                            </xsl:with-param>
                                            <xsl:with-param name="supp">
                                                <xsl:value-of
                                                  select="item-info/assigned-to-issue/supp"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                    </td>
                                </tr>
                                <tr>
                                    <td>S250 sequence number:</td>
                                    <td>
                                        <xsl:value-of select="item-info/s250-sequence-number"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Pages:</td>
                                    <td>
                                        <xsl:call-template name="insert-page-range">
                                            <xsl:with-param name="type">
                                                <xsl:value-of select="item-info/page-range/@type"/>
                                            </xsl:with-param>
                                            <xsl:with-param name="first-page">
                                                <xsl:value-of
                                                  select="item-info/page-range/first-page"/>
                                            </xsl:with-param>
                                            <xsl:with-param name="last-page">
                                                <xsl:value-of
                                                  select="item-info/page-range/last-page"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                    </td>
                                </tr>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>
                                                ...
                                                <xsl:if test="//refers-to-document[2]/pii!=''">, <br>
                                                  <xsl:value-of
                                                  select="//refers-to-document[2]/pii"/>
                                                  </br>
                                                </xsl:if>
						...
						<xsl:for-each select="//figure">
                                            ...
                                            <td>
                                                ...
                                                <xsl:if test="//refers-to-document[2]/doi!=''">, <br>
                                                  <xsl:value-of
                                                  select="//refers-to-document[2]/doi"/>
                                                  </br>
                                                </xsl:if>
    ...
    <!--################################################################################-->
    <!--This section is for formatting the first-author name-->
...
<td width="10%">Response:</td>
    ...
    <xsl:template match="funding">
        ...
        <tr>
            <td>NIHMS-ID:</td>
            <td>
                <xsl:value-of select="nihms-id"/>
            </td>
        </tr>
        <tr>
            <td>PubMedCentral ID:</td>
            <td>
                <xsl:value-of select="pubmedcentral-id"/>
            </td>
        </tr>
        <!--      <tr>
...
-->
    ...
    <!--#####################################################################################-->
    <!-- This section is for formatting the volume-issue information -->

    <xsl:template name="insert-voliss-info">
    ...
    <xsl:template name="insert-page-range">
        ...
        <xsl:value-of select="concat($first-page,'-',$last-page,' (',$type,')')"/>
    </xsl:template>
