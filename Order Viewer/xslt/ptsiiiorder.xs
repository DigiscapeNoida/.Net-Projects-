...
<!--
     version 1.10  7 April 2015
     Copyright (c) 2011-2015 Elsevier B.V.
-->
<!--
...
<!--				<tr>
	...
	<xsl:template match="item-info">
	    ...
	    article-number           no-bw-figs
            ...
            CrossMark                no-e-components
            copyright status         batch
            employer                 refers-to-document
            copyright received date
            license                  e-submission-item-nr
            embargo                  eo-item-nr
            embargo-until-stage      editor
            righthand start          received date
            online publication date  revised date
            online version           accept date
            corrections     
            offprint payment
        -->
		<p>
