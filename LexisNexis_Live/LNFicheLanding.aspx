<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContent.master" AutoEventWireup="true" CodeFile="LNFicheLanding.aspx.cs" Inherits="LexisNexis.EncyclopediasLanding" EnableEventValidation="false" %>
        ...
        $(document).ready(function () {
            $('.filter').click(function () {
                ...
                $.ajax({
                   ...
                   // url: "http://localhost:49430/LexisNexis/Fiche.svc/data?ColumnName=" + colName,
                    processData: false,
...
<div class="box2">
    <asp:Button ID="Btn_Cancel" runat="server" CssClass="button_one" Text="Cancel" Visible="true" OnClick="Btn_Cancel_Click" />
                            <asp:Button ID="Btn_Delete" runat="server" CssClass="button_one" Text="Delete" Visible="true" OnClick="Btn_Delete_Click" />
...
<div id="divFilter"></div>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="comment">
                  ...
                  <asp:ImageButton ID="img1" runat="server" CommandArgument='<%# Eval("comments") %>' CommandName="comment" ImageUrl="~/images/icon-comment.png" />
                        <asp:Literal ID="ltlimg" runat="server" Text='<%# Eval("comments")%>' Visible="false"></asp:Literal>
                                          <asp:Literal ID="ltlrid" runat="server" Text='<%# Eval("FRID")%>' Visible="false"></asp:Literal>
                       </ItemTemplate>
               </asp:TemplateField>
               ...
               <asp:TemplateField HeaderText="task">  
                   ...
                   <%-- Edited by Kshitij 22-Feb-2017 for edit and update delete and cancel --%>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Button ID="btn_Edit" runat="server" CssClass="gry_btn" Text="modifier" CommandName="showModal" CommandArgument='<%# Eval("FID") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
    ...
    <!-- The Modal -->
    <div id="myModal" class="modal_update"  >
        ...
        <div class="modal-content" style="height:430px;">
            <span class="close" onclick="Close()">&times;</span>
                    ...
                    <asp:Label ID="lblAdminficheupdate" Text=" <h2>Envoyer le(s) fiche(s) en production</h2>" runat="server"></asp:Label>
             ...
             <div class="row">
                 ...
                 <div class="col">
                          <asp:TextBox ID="txtupdatecomment" runat="server" TextMode="MultiLine" CssClass="textarea_1"></asp:TextBox>
                     </div>

                      </div>

            <div class="row">
                      <asp:Label ID="lblLoadaFileefiche1" Text="Load a file" runat="server"></asp:Label>
                            <asp:FileUpload ID="FileUpload2" CssClass="fileUpload"
