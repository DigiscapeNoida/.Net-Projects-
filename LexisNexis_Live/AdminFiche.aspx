<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContent.master" AutoEventWireup="true" CodeFile="AdminFiche.aspx.cs" Inherits="LexisNexis.FicheLanding" EnableEventValidation="false" %>
...
<div class="sub_page_header">
    ...
    <ul class="tp_tab">
        ...
        <li class="active"><a href="#"  onclick= "Redirect('AdminFiche.aspx')"> <asp:Label ID="lblFichemenu" runat="server" text="Fiches de mise à jour"></asp:Label> </a> </li>
...
<asp:Label ID="lblficheadminhead" Text="Fiches de mise à jour" runat="server"></asp:Label>
...
<asp:Button ID="btnExportExcelAll" runat="server" CssClass="button_one" Text="Export All" OnClick="btnExportExcelAll_Click" />
         <asp:Button ID="btnremoveFiche" runat="server" CssClass="button_one" Visible="true" Text="Annuler" OnClick="btnremove_Click"  OnClientClick="Confirm()"   />
</div>
        ...
        <asp:GridView ID="grdViewOrders" runat="server"
            ...
            <Columns>
               ...
               <asp:TemplateField HeaderText="attachments" Visible="false">  
                  ...
                  <asp:TemplateField HeaderText="SGM LN"  Visible="false">  
                                    <ItemTemplate>  
                                        <asp:LinkButton ID="lnksgm" runat="server" CausesValidation="False" CommandArgument='<%# Eval("FID") %>'  
                                            CommandName="lnsgm" Text='<%# Eval("Sgm_Filename") %>' />  
                                    </ItemTemplate>  
                                </asp:TemplateField>  
                  <asp:TemplateField HeaderText="Error LN"  Visible="false">  
                                    <ItemTemplate>  
                                        <asp:LinkButton ID="lnkerror" runat="server" CausesValidation="False" CommandArgument='<%# Eval("FID") %>'  
                                            CommandName="Logerror" Text='<%# Eval("errorfilename") %>' />  
                                    </ItemTemplate>  
                                </asp:TemplateField>   
            ...
            <div class="modal" id="modal-one" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-footer">
                          <asp:Button ID="btnCancel" runat="server" CssClass="red_btn" Text="Close" OnClick="btnCancel_Click"  />
                        &nbsp;
