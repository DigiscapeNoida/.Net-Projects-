<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TDUploadFile.aspx.cs" Inherits="TDUploadFile" %>
...
<asp:Label ID="lblHeading" runat="server" Text="TD"></asp:Label><strong class="bracket">(</strong><asp:Label ID="lblheading2" runat="server" Text="Encyclopedia"></asp:Label><strong class="bracket">)</strong>
