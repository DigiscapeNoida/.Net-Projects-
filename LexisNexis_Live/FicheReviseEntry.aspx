<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContent.master" AutoEventWireup="true" CodeFile="FicheReviseEntry.aspx.cs" Inherits="EncyclopediaReviseEntry1" %>
...
<asp:Label ID="lblHeadinger" runat="server" Text="Log correction"></asp:Label><strong class="bracket">(</strong><asp:Label ID="lblheading2fs" runat="server" Text="Fiche"></asp:Label><strong class="bracket">)</strong>
...
<div class="row">
 <asp:Label ID="lblCommenter" Text="Comment" runat="server" Visible="false"></asp:Label>
<asp:TextBox ID="txtcomment" runat="server" TextMode="MultiLine" CssClass="textarea_1" Visible="false"></asp:TextBox>
</div>
