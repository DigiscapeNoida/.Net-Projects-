...
public partial class AdminUserCreate : System.Web.UI.Page
{
    ...
    protected void btnUserCreate_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            paramList[3] = new SqlParameter("@roleid", "LN");//ddlrole.SelectedValue.ToString()
            ...
            if (rowAffected > 0)
            {
                string msg = rm.GetString("User_created_successfully", ci);
                Page.ClientScript.RegisterStartupScript(GetType(), "modelBox", "alert('" + msg + "')", true);
    ...
    /// <summary>
    ///  Edited by Kshitij For edit and update grid
    /// </summary>
    ...
    protected void grdUser_RowUpdating(object sender, System.Web.UI.WebControls.GridViewUpdateEventArgs e)
    {
      ...
      //  edit_prodsite.SelectedValue = lblprodid.Text;
        ...
        string user = grdUser.Rows[e.RowIndex].Cells[0].Text;
         ...
         string query = "Update  login set FIRSTNAME = '" + firstName + "', LASTNAME = '" + LastName + "', ROLEID='LN', PRODID='" + prodId + "', ACTIVE='Yes' where USERID = '" + user + "'";
