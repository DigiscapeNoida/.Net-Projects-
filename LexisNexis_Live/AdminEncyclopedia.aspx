<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContent.master" AutoEventWireup="true" CodeFile="AdminEncyclopedia.aspx.cs" Inherits="LexisNexis.EncyclopediasLanding" EnableEventValidation="false" %>
...
<div class="sub_page_header">
     <ul class="tp_tab">
        ...
        <li class="active"><a href="#"  onclick= "Redirect('AdminEncyclopedia.aspx')">  <asp:Label ID="lblencyclomenu" runat="server" text="Encyclopédies"></asp:Label> </a>  </a> </li>
...
<asp:Label ID="lblencysloadminhead" Text="Encyclopédies" runat="server"></asp:Label>
...
<asp:Button ID="btnExportExcelAll" runat="server" CssClass="button_one" Text="Export All" OnClick="btnExportExcelAll_Click" />
         <asp:Button ID="btnremove" runat="server" CssClass="button_one" Visible="true" Text="Remove" OnClick="btnremove_Click"  OnClientClick="Confirm()"  /></div>
</div>
