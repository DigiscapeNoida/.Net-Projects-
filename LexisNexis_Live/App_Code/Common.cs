...
public class Common
{
    ...
    public static void SendEmail(string stTo, string stCc, string stSubject, string stBody)
    {
        ...
        smtpClient.Credentials = new System.Net.NetworkCredential("productiontd@thomsondigital.com", "Wof21377");
        smtpClient.Port = 587;
        ...
        MailAddress fromAddress = new MailAddress("productiontd@thomsondigital.com");
