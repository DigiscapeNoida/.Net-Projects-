<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContent.master" AutoEventWireup="true" CodeFile="TDUploadFile_Fiches.aspx.cs" Inherits="TDUploadFile1" %>
...
<asp:Label ID="lblHeadingtd" runat="server" Text="TD"></asp:Label><strong class="bracket">(</strong><asp:Label ID="lblheading2tdfiche" runat="server" Text="Fiche"></asp:Label><strong class="bracket">)</strong>
...
<div class="row">
 <asp:Label ID="lblCommenttd" Text="Comment" runat="server" Visible="false"></asp:Label>
