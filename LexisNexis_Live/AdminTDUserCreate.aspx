<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContent.master" AutoEventWireup="true" CodeFile="AdminTDUserCreate.aspx.cs" Inherits="AdminTDUserCreate" %>
...
<!--
                    <ul class="tp_tab">
                        <li class="active"><a href="#" onclick="Redirect('AdminTDUserCreate.aspx')">
