...
namespace LexisNexis
{
    public partial class EncyclopediasLanding : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            */
            ...
            strQuery = "select a.*,l.firstname+' '+l.lastname as fullname from login l, fiches a inner join (select fid,max(iteration) as iteration from fiches group by fid )b on a.fid = b.fid and a.iteration = b.iteration  WHERE  a.userid=l.userid";
        ...
        protected void grdViewOrders_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            if (Session["searchqryfiche"] != null)
            {
                ...
                strQuery = Session["searchqryfiche"].ToString();
            }
            else
            {
                if (ddlCollection.SelectedItem.Text != "----------" && ddlwriting.SelectedItem.Text != "----------")
            ...
            {
                strQuery = strQuery + " order by FID";
            }
        ...
        protected void grdViewOrders_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            */
            ...
            if (e.CommandName == "showModal")
            {
                ...
                //Txt_TitleFesc.Text = HttpUtility.HtmlDecode(Convert.ToString(grdViewOrders.Rows[RowIndex].Cells[1].Text));
                //Txt_Folio.Text = HttpUtility.HtmlDecode(Convert.ToString(grdViewOrders.Rows[RowIndex].Cells[2].Text));
                //Txt_DateEnroll.Text = DateTime.Now.ToString("dd/MM/yyyy");
                //string temp = HttpUtility.HtmlDecode(Convert.ToString(grdViewOrders.Rows[RowIndex].Cells[3].Text));
                //DDL_Nature.SelectedItem.Text = temp;
                //Txt_TitleFesc.Text = HttpUtility.HtmlDecode(Convert.ToString(grdViewOrders.Rows[RowIndex].Cells[8].Text));

                //temp = HttpUtility.HtmlDecode(Convert.ToString(grdViewOrders.Rows[RowIndex].Cells[4].Text));
                //DDL_tat.SelectedItem.Text = temp;
      ...
      protected void ddltask_SelectedIndexChanged(object sender, EventArgs e)
        ...
        protected void btnremovefilter_Click(object sender, EventArgs e)
        {
            ...
            string strQuery = "select a.*,l.firstname+' '+l.lastname as fullname from login l, fiches a inner join (select fid,max(iteration) as iteration from fiches group by fid )b on a.fid = b.fid and a.iteration = b.iteration  WHERE  a.userid=l.userid and a.Active <> 'No'";
        ...
        protected void openButton_Click(object sender, EventArgs e)
        {
           ...
           /* Response.Redirect("http://localhost:49430/LexisNexis/FicheLanding.aspx#modal-one");*/
          ...
          //  Page.RegisterStartupScript("ScrollToBottom", "<script language='javascript'>" + System.Environment.NewLine +
          //"window.location.href ='" + "http://"+dddddd+"/LexisNexis/FicheLanding.aspx#modal-one" +"';" + System.Environment.NewLine +
          //"</script>");


            Page.RegisterStartupScript("ScrollToBottom", "<script language='javascript'>" + System.Environment.NewLine +
         "window.location.href ='" + "http://localhost:49430/LexisNexis/LNFicheLanding.aspx#modal-one" + "';" + System.Environment.NewLine +
         "</script>");
        }
   ...
   /*     protected void Button1_Click(object sender, EventArgs e)
                ...
                foreach (GridViewRow gvrow in grdViewOrders.Rows)
                {
                    ...
                    if (chck.Checked)
                    {
                        ...
                        if (action.Equals("delete", StringComparison.InvariantCultureIgnoreCase))
                        {
                            ...
                            query = "Update FICHES set Active='NO', itemComplete_date='" + DateTime.Now.Subtract(T1) + "', STAGE = 'Deleted' where did='" + id.Trim() + "'";
                        ...
                        {
                            query = "Update FICHES set  itemComplete_date='" + DateTime.Now.Subtract(T1) + "', STAGE = 'Annulé' where did='" + id.Trim() + "'";
                            int res = DataAccess.ExecuteNonQuery(query);
                            if (res > 0)
                            {
                                Sendemail("", id);
        ...
        protected void Btn_Save_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload2.HasFile)
            {
                ...
                if (ext.ToLower() == ".doc" || ext.ToLower() == ".docx")//ext == ".zip" || ext == ".rar" || ext == ".7zip" || 
                {
                    ...
                    try
                    {
                        ...
                        FileUpload2.SaveAs(Expath + "\\" + Session[SESSION.LOGGED_PRODSITE].ToString() + "\\LN" + "\\" + did + "\\" + filename);
            ...
            if (filename == "")
            {
                query = "Update  FICHES set comments = '" + txtcomment.Text.Trim() + "'  where FRID = '" + txt_rid.Text.Trim() + "'";
            }
            else
            {
                query = "Update  FICHES set comments = '" + txtcomment.Text.Trim() + "',filesname='"+filename+"',PAGECOUNT=null,  where FRID = '" + txt_rid.Text.Trim() + "'";
            }
