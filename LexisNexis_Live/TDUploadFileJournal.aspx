<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContent.master" AutoEventWireup="true" CodeFile="TDUploadFileJournal.aspx.cs" Inherits="TDUploadFile1" %>
...
<asp:Label ID="lblHeadingtd" runat="server" Text="TD"></asp:Label>
...
<asp:Label ID="hiddenval" runat="server" Visible="false"></asp:Label>
        <asp:Label ID="hiddenval1" runat="server" Visible="false"></asp:Label>
          <asp:Label ID="hiddenval2" runat="server" Visible="false"></asp:Label>
</div>
