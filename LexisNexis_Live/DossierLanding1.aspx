<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContent.master" AutoEventWireup="true" CodeFile="DossierLanding1.aspx.cs" Inherits="LexisNexis.DossierLanding1" EnableEventValidation="false" %>
        ...
        $(document).ready(function () {
            $('.filter').click(function () {
                ...
                $.ajax({
                  ...
                  //  url: "http://localhost:49430/LexisNexis/Service1.svc/data?ColumnName=" + colName,
                    processData: false,
...
<div class="box2">
    ...
    <asp:Button ID="btnremove" runat="server" CssClass="button_one" Text="Remove" Visible="false" OnClick="btnremove_Click" OnClientClick="Confirm()" />
