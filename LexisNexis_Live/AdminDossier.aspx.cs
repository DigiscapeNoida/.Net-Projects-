...
{
    public partial class AdminDossier : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
			...
			else
            {
               // strQuery = "SELECT * FROM NEWS where  Active<> 'No'";
                strQuery = " select n.*,l.firstname+' '+l.lastname as fullname from news n , login l WHERE n.userid=l.userid and n.stage='Dossier envoyé à Thomson'";
            }
            */
        ...
        protected void grdViewOrders_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
           ...
           "CONVERT(VARCHAR(10), n.publicationdate, 103) + ' '  + convert(VARCHAR(8), n.publicationdate, 14) as publicationdate," +
           "CONVERT(VARCHAR(10), n.deletiondate, 103) + ' '  + convert(VARCHAR(8), n.deletiondate, 14) as deletiondate" +
           ",l.firstname+' '+l.lastname as fullname from news n , login l WHERE n.userid=l.userid and n.stage='Dossier envoyé à Thomson'";
                    ...
                    if (rowresult > 0)
                    {
                        ...
                        if (set.Tables[0].Rows.Count > 0)
                        {
                           ...
                           // string strLT = Session[SESSION.LOGGED_ROLE].ToString();
                            ...
                            string strLink = "<a href=\"http://59.160.102.176:8081/default.aspx\">http://59.160.102.176:8081/default.aspx</a>";
