<%@ Page Title="" Language="C#" MasterPageFile="~/MasterContent.master" AutoEventWireup="true" CodeFile="JournalLanding.aspx.cs" Inherits="LexisNexis.EncyclopediasLanding" EnableEventValidation="false" %>
        ...
        $(document).ready(function () {
            $('.filter').click(function () {
                ...
                $.ajax({
                    type: "GET",
                   // type: "POST",
                    //url: "https://online.thomsondigital.com/ln_test/Journal.svc/data?ColumnName=" + colName,
                    url: "https://online.thomsondigital.com/live_api/api/values/" + colName,
                    async: true,
                    data: '',
                    //url: "Journal.svc/GetDistinctValue",
                    //data: JSON.stringify({strColumnName:colName}),
                    processData: true,
                    crossDomain: false,
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lnkvalidate" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Articleid") %>'
                                            CommandName="Validate" Text="Archiver" Visible="false" OnClientClick="return confirm('Attention ! Le document sera supprimé de la plateforme. Continuer ?')" OnClick="ValidateFile" />
                                        &nbsp;&nbsp;
