...
<asp:DropDownList ID="ddlworktobedone" runat="server" CssClass="select_2" AutoPostBack="false">
	...
	<asp:ListItem Text="Préparation + balisage en FS_Presse" Value="Préparation + balisage en FS_Presse"></asp:ListItem>
    <asp:ListItem Text="Balisage en FS_Presse uniquement" Value="Balisage en FS_Presse uniquement"></asp:ListItem>
</asp:DropDownList>
</div>
    <div class="row colle">
         <div class="col"> 
