...
public partial class EncycloSearch : System.Web.UI.Page
{
    ...
    protected void btnSend_Click(object sender, EventArgs e)
    {
        ...
        string SQLQuery = "select a.*,l.firstname+' '+l.lastname as fullname from login l, encyclopedia a inner join (select eid,max(duedate) as duedate from encyclopedia group by eid )b on a.eid = b.eid and a.duedate = b.duedate where  a.userid=l.userid and a.Active <> 'No'";
        if (reduction != "")
        {
        ...
        {
            SQLQuery = SQLQuery + " and DTITLE = '" + txttitle.Text.Trim() + "'";
        }
        ...
        Session["searchqryEncyclo"] = SQLQuery;
