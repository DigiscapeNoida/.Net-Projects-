        ...
        <html>
            ...
            <body onkeyup="keyDown=0" onkeydown="keyDown=1">
                ...
                <table width="1000" border="1" style="margin-top:20pt;">
                    <tr>
                        <td colspan="2" align="center" style="font-weight:bold;">Version 2019.2 | ©
                            2018 Elsevier | Contact: Rob van Fucht <span
                                style="font-size:14; font-weight:normal"
                                >(R.Fucht@elsevier.com)</span>, Gopinath Rajasekaran <span
                                style="font-size:14; font-weight:normal"
                                >(g.rajasekaran@elsevier.com)</span>, <br/>Vanaja Sriram <span
                                style="font-size:14; font-weight:normal"
                                >(v.sriram@elsevier.com)</span></td>
                    </tr>
                </table>
...
-->
    ...
    <xsl:template match="jss:journalStylesheet/jss:s0" name="s0">
        <table border="4" width="1000pt">
            ...
            <tr>
                <th class="head3" colspan="2">LeMans Dates</th>
            </tr>
            <tr>
                <td>
                    <font class="lhs">
                ...
                <td>
                    <font class="rhs">
                        <xsl:value-of
                            select="jss:journalStylesheet/jss:baseData/jss:ptsData/jss:leMansDates/jss:journalAttrDateFrom_LeMans"
                        />
                    </font>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <font class="rhs">
                        <xsl:value-of
                            select="jss:journalStylesheet/jss:baseData/jss:ptsData/jss:leMansDates/jss:journalAttrDateTo_LeMans"
                        />
                    </font>
                </td>
            </tr>
    ...
    <xsl:template match="jss:journalStylesheet/jss:s100" name="s100">
        <table border="4" width="1000pt">
            ...
            <tr>
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:when
                            test="//jss:degreesAndTitles/jss:journalSpecificDegreesTitles = '2'">
                            <font class="rhs">
                                <xsl:text>Use only for specific PITs</xsl:text>
                            </font>
                        </xsl:when>
                        <xsl:when
            ...
            <tr>
                <td>
                    <font class="lhs">
                        <xsl:text>Proofing System Reference Style</xsl:text>
                    </font>
                </td>
                <td>
                    <xsl:choose>
                        <xsl:when
                            test="//jss:s100/jss:proofingSystem/jss:proofingSystemReferenceStyle!=''">
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:s100/jss:proofingSystem/jss:proofingSystemReferenceStyle"
                                />
                            </font>
                        </xsl:when>
                        <xsl:when
            ...
            <tr>
                <td>
                    <font class="lhs">
                        <xsl:text>Proofing System Typeset Model</xsl:text>
                    </font>
                </td>
                <td>
                    <xsl:choose>
                        <xsl:when
                            test="//jss:s100/jss:proofingSystem/jss:proofingSystemTypesetModel!=''">
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:s100/jss:proofingSystem/jss:proofingSystemTypesetModel"
                                />
                            </font>
                        </xsl:when>
                        <xsl:when
            ...
            <tr>
                <td>
                    <font class="lhs">
                        <xsl:text>Proofing System Name</xsl:text>
                    </font>
                </td>
                <td>
                    <xsl:choose>
                        <xsl:when test="//jss:s100/jss:proofingSystem/jss:proofingSystemName!=''">
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:s100/jss:proofingSystem/jss:proofingSystemName"/>
                            </font>
                        </xsl:when>
                        <xsl:when test="//jss:s100/jss:proofingSystem/jss:proofingSystemName=''">
                            <font class="rhs_nodata">
            ...
            <tr>
                <td>
                    <font class="lhs">
                        <xsl:text>Proofing System Version</xsl:text>
                    </font>
                </td>
                <td>
                    <xsl:choose>
                        <xsl:when test="//jss:s100/jss:proofingSystem/jss:proofingSystemVersion!=''">
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:s100/jss:proofingSystem/jss:proofingSystemVersion"
                                />
                            </font>
                        </xsl:when>
                        <xsl:when test="//jss:s100/jss:proofingSystem/jss:proofingSystemVersion=''">
            ...
            <tr>
                <td>
                    <font class="lhs">
                        <xsl:text>Proofing System Workflow</xsl:text>
                    </font>
                </td>
                <td>
                    <xsl:choose>
                        <xsl:when
                            test="//jss:s100/jss:proofingSystem/jss:proofingSystemWorkflow!=''">
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:s100/jss:proofingSystem/jss:proofingSystemWorkflow"
                                />
                            </font>
                        </xsl:when>
                        <xsl:when test="//jss:s100/jss:proofingSystem/jss:proofingSystemWorkflow=''">
                            <font class="rhs_nodata">
                                <xsl:text>Contains no data</xsl:text>
                            </font>
                        </xsl:when>
            ...
            <tr>
                <td>
                    <font class="lhs">
                        <xsl:text>Proofing System View Mode</xsl:text>
                    </font>
                </td>
                <td>
                    <xsl:choose>
                        <xsl:when
                            test="//jss:s100/jss:proofingSystem/jss:proofingSystemViewMode!=''">
                            <font class="rhs">
                                <xsl:value-of
                                    select="//jss:s100/jss:proofingSystem/jss:proofingSystemViewMode"
                                />
                            </font>
                        </xsl:when>
                        <xsl:when test="//jss:s100/jss:proofingSystem/jss:proofingSystemViewMode=''">
                            <font class="rhs_nodata">
                                <xsl:text>Contains no data</xsl:text>
                            </font>
                        </xsl:when>
        ...
        <table border="4" width="1000pt">
            <tr>
                <td>
                    ...
                    <br/>
                    <h3 align="left" class="head3">Sponsored supplements and/or commercial
                        reprints</h3>
                    <xsl:text>&#8195;</xsl:text>
                    ...
                    <xsl:if test="//jss:ordersClaimsJournalEnquiries/jss:sectiontitle">
                        <font class="head4">
                            <xsl:value-of
                                select="//jss:ordersClaimsJournalEnquiries/jss:sectiontitle"/>
                            <xsl:text>: </xsl:text>
                        </font>
                    </xsl:if>
                    ...
                    <br/>
                    <h3 align="left" class="head3">Texts for journals with copyright Elsevier
                        GmbH</h3>
