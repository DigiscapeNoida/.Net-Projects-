#pragma checksum "D:\WinCVS\ThimeXMLORDER\App_Code\XmlOrder.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "347523F682CAF30C2EB6CB9BFB73ED75248BD995"

#line 1 "D:\WinCVS\ThimeXMLORDER\App_Code\XmlOrder.cs"
using System;
using System.Text;
...
namespace Orders
{
    ...
    public class XmlOrder   
    {
        ...
        private string GetOrderPath()
        {
            ...
            {
                OrderPath = ConfigDetails.RootPath.Trim(new char[] { '\\' }) + "\\" + _Client + "\\" + _JID + "\\" + _AID + "\\" + _FMSStage;
            }
        ...
        private void ProcessNode(XmlNode node, out bool endElement)
        {
            ...
            switch (node.Name)
            {
                ...
                case "order":
                    ...
                    textWriter.WriteAttributeString("customer","EMC");
                    textWriter.WriteAttributeString("category","JOURNAL");
                    break;
                case "time":
                    textWriter.WriteStartElement(node.Name);
