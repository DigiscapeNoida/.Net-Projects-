#pragma checksum "D:\WinCVS\ThimeXMLORDER\OrderCreator.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "F4827E5F2995D895EDD8A99D3ED994B122DD41CC"

#line 1 "D:\WinCVS\ThimeXMLORDER\OrderCreator.aspx.cs"
using System;
...
public partial class OrderCreator : System.Web.UI.Page
{
    ...
    protected void cmdGenerate_Click(object sender, EventArgs e)
    {
        ...
        if (XmlOrderOBJ.Client.Equals("MEDKNOW", StringComparison.OrdinalIgnoreCase))
        {
            ...
            {
                XmlOrderOBJ.DocName = Orders.Global.GetDocFileName(SaveTo);
    ...
    private void InsertArticleDetailForWIP()
    {
        ...
        using (SqlConnection conn = new SqlConnection(connString))
        {
            ...
            if (conn.State == ConnectionState.Open)
            {
                ...
                command.Parameters.Add(new SqlParameter("@AID", txtAID.Text.Trim()));
                ...
                command.Parameters.Add(new SqlParameter("@ServerIP", "172.16.2.128"));
