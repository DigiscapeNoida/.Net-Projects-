                  ...
                  <table width="100%" frame="all" border="1">
                    <tr>
                      <td width="60%">
                        ...
                        <table width="100%" frame="topbot" >
                          <tr>
                            <td width="50%">
                              <b>E-Proofing To Mail:</b>
                            </td>
                            <td width="50%">
                          ...
                          <tr>
                            <td>
                              <table width="100%" height="100%">
                                ...
                                <tr>
                                  <td>
                                    <b>Supplementry Material:</b>
                                  </td>
                                  <td>
                                    <xsl:for-each select="//suppmat">
